...
st.text("")
st.write("The Rietveld equation and the parameters were modified and are working! However lmfit does a bad job here, as its purpose is to fit through multiple points close together at the x-axis. Ongoing work is done here. Need a conversion to a line graph and still run all parameters. Or you are welcome to try with a very long diffraction time.")
st.text("")
st.write("##### Literature")
