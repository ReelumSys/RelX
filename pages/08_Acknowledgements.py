...
st.markdown('<div style="text-align: justify;">A Williamson-Hall-Plot, Scherrer-Formula and Halder and Wagner-Plot and other functions were formulated. The Scherrer calculation is based on gaussian FWHM values. Furthermore a Halder and Wagner-Plot is made with modifications possible from the Literature. The plots should serve as a direct comparison between the three methods.</div>', unsafe_allow_html=True)
st.text("")
...
st.text("")
st.write("##### Literature")
st.markdown('<div style="text-align: justify;">Rietveld, H. M. (1969) A profile refinement method for nuclear and magnetic structures. J. Appl. Cryst., 2: 65-71. <a href="https://doi.org/10.1107/S0021889869006558r">https://doi.org/10.1107/S0021889869006558r</a> </div>', unsafe_allow_html=True)
st.text("")
st.markdown('<div style="text-align: justify;">Flores-Cano, D. A., Chino-Quispe, A. R., Rueda Vellasmin, R., Ocampo-Anticona, J. A., González, J. C., & Ramos-Guivar, J. A. (2021) Fifty years of Rietveld refinement: Methodology and guidelines in superconductors and functional magnetic nanoadsorbents. Revista De Investigación De Física, 24(3), 39-48. <a href="https://doi.org/10.15381/rif.v24i3.21028">https://doi.org/10.15381/rif.v24i3.21028</a> </div>', unsafe_allow_html=True)
st.text("")
...
st.text("")
st.markdown('<div style="text-align: justify;">Hall, W. H. (1949) Proc. Phys. Soc. A (London, U. K.) 62 741–743. </div>', unsafe_allow_html=True)
st.text("")
...
st.text("")
st.markdown('<div style="text-align: justify;">Thanks to Andy Garcia for Rietveld  </div>', unsafe_allow_html=True)
st.text("")
