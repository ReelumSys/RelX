...
st.text("")
st.write("##### Literature")
st.markdown('<div style="text-align: justify;">Rietveld, H.M. (1969) A profile refinement method for nuclear and magnetic structures. J. Appl. Cryst., 2: 65-71. <a href="https://doi.org/10.1107/S0021889869006558rk">https://doi.org/10.1107/S0021889869006558rk</a> </div>', unsafe_allow_html=True)
