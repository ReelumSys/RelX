...
user_input = st.number_input("Please enter a starting number for degree 2Theta. Minimun should be at least the first higher number degree 2Theta data point of the two diffraction patterns, so they can adjust.")
