...
user_input = st.number_input("Please enter a starting number for 2Theta. Minimun should be at least the first higher number degree 2Theta data point of the two diffraction patterns, so they can adjust.")
...
np.savetxt('ksev1.csv', weather1, fmt='%f', delimiter=',')
