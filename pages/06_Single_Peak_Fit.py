...
st.text("")
st.markdown('<div style="text-align: justify;"> <font size="+3"><b> Detects all prominent peaks in the range of selected °2Theta values. <b></font> </div>', unsafe_allow_html=True)
