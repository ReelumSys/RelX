...
st.text("")
st.markdown('<div style="text-align: justify;"> <font size="+3"><b> With this app it is possible to do some work on XRD Charts with only minimal amounts of data needed. For the Symmetry depicition HKL values are needed. <b></font> </div>', unsafe_allow_html=True)
