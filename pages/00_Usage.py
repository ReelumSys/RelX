...
st.write("###### With this app it is possible to do some work on XRD Charts with only very few amounts of data. Since for Rietveld Refinement only atomic parameters and HKL-values are needed. Same for the Bravais crystal structure.")
st.text("")
