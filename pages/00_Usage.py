...
st.text("")
st.markdown('<div style="text-align: justify;"> <font size="+5"> With this app it is possible to do some work on XRD Charts with only minimal amounts of data needed. Since for Rietveld Refinement only atomic parameters and HKL-values are required. Same for the Bravais crystal structure depiction.</font> </div>', unsafe_allow_html=True)
