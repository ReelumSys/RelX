...
st.text("")
st.markdown('<div style="text-align: justify;"> <font size="+3">The Rietveld equation and the parameters were modified and are working, only few additional values need to be set like the position of the atoms, or scale factor. These values need to be incorporated on the front-end. Ongoing work is done here. Maybe needing a conversion to a line graph and still run all parameters. Or you are welcome to try with a very long diffraction time. </font> </div>', unsafe_allow_html=True)
